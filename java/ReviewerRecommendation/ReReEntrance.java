...
public class ReReEntrance {
    ...
    //设置训练数据的时效性，M天以内的pull request都被用作训练
	public int M = 90;

	//训练数据的时效性参数设置，用于设定参与训练最新的PR个数，最少为N个
	public int N = 500;

    //staged-algorithm 重新训练的PR个数
	public int cnt = 100;
	...
	private void outputResult(int num, double[] precision, double[] recall, double mrr,
        ...
        try {
            ...
            System.out.println("关闭csvwriter出错！");
            e.printStackTrace();
        }
